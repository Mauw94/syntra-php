...
class Ordersadmin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'ordersadmin/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'ordersadmin/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'ordersadmin/index.html';
            $config['first_url'] = base_url() . 'ordersadmin/index.html';
        }
        ...
        $this->load->view('ordersadmin/ordersadmin_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'status_id' => $row->status_id,
            ...
            $this->load->view('ordersadmin/ordersadmin_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('ordersadmin'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('ordersadmin/create_action'),
	    'id' => set_value('id'),
        ...
        $this->load->view('ordersadmin/ordersadmin_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('ordersadmin/update_action'),
...
/* End of file Ordersadmin.php */
/* Location: ./application/controllers/Ordersadmin.php */                     /* Ordersadmin is COPY FROM Orders */
