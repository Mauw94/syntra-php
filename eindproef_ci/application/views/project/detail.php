<div class="container">
    ...
    <div class="company-landing">
        ...
        <a href="<?php echo base_url();?>user/apply_to_project/<?php echo $project[0]->id;?>/<?php echo $company[0]->id;?>" class="btn btn-success"><b>APPLY!</b></a>
        <a href="<?php echo base_url();?>user/favorite_project/<?php echo $project[0]->id;?>" class="btn btn-info"><b>Favorite</b> <i class="fas fa-heart"></i></a>
