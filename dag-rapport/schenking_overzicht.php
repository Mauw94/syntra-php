...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
    ...
    <a href="schenking_overzicht.php" class="w3-bar-item w3-button w3-padding-large w3-black">
    <i class="fa fa-gift w3-xxlarge"></i>
...
<div class="w3-content w3-justify w3-text-black w3-padding-64 overzicht-table">
    <hr>
    <?php
        $sql = "SELECT * FROM schenkingen";
        $result = mysqli_query($con, $sql);                
        ?>
        <div>
        <h2 class="mb-4">Schenkingen</h2>
            <table id="overzicht" class="table">
            <thead class="thead-light">
                <tr>
                    <th scope="col">Naam schenker</th>
            ...
            while ($output = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>' . $output['omschrijving'].'</td>';
            }
            ?>
            </tbody>
            </table>
